...
const Login = () => {
  ...
  const loginHandle = (e) => {
    ...
    const getuserArr = localStorage.getItem("register-user");
    ...
    if (email === "") {
      ...
      if (getuserArr && getuserArr.length) {
        ...
        if (userlogin.length === 0) {
          toast.error('Invalid detail... please retry...')
        }
        else {
          const status = true;
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <form id="formAuthentication" className="mb-3">
                    ...
                    <div className="mb-3">
                      <button className="btn btn-primary d-grid w-100" onClick={loginHandle} type="submit">
                        Sign in
                      </button>
                    </div>
                  </form>
