...
const Register = () => {
  ...
  const submitData = (e) => {
    ...
    // }
      ...
      history("/")
      localStorage.setItem("register-user", JSON.stringify([...data, inputData]));
                  ...
                  <>
                    ...
                    <div className="app-brand justify-content-center">
                      <a className="app-brand-link gap-2">
                        <span className="app-brand-logo demo sneat-logo1">
                          <svg
                            width={25}
                            viewBox="0 0 25 42"
                            version="1.1"
                        ...
                        <span className="sneat-logo">Sneat</span>
                      </a>
                    </div>
                    {/* /Logo */}
                  </>
                    ...
                    <div className="mb-3">
                      <div className="form-check">
                        ...
                        <label className="form-check-label" >
                          I agree to
                          <Link to="javascript:void(0);">  privacy policy &amp; terms</Link>
                        </label>
                      </div>
                    </div>
                    <button className="btn btn-primary d-grid w-100" onClick={submitData}>Sign up</button>
                  </form>
